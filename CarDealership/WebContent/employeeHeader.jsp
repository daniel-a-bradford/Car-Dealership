...
<nav class="navbar navbar-expand-md navbar-dark pt-5 bg-dark" style="dark-blue">
	...
	<div class="collapse navbar-collapse" id="navbarCollapse">
		<ul class="navbar-nav mr-auto">
			...
			<li class="nav-item"><a class="nav-link" href="transactions.jsp">View Transactions<span class="sr-only">(current)</span>
			</a></li>
			<li class="nav-item"><a class="nav-link disabled" href="#" tabindex="-1" >Update Inventory</a></li>
		</ul>
	</div>
</nav>
